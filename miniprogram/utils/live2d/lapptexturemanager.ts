...
import { csmVector, iterator } from '../live2d-sdk/type/csmvector';

import { gl } from './lappdelegate';

// 用于 createImage 的离屏 2D canvas（小程序全局可用）
let s_offscreenCanvas: any = null;
function getImageCanvas(): any {
  if (s_offscreenCanvas) return s_offscreenCanvas;
    ...
    public createTextureFromPngFile(
        ...
        for (
            ...
            if (
                ...
                query.select('#img').node().exec((res: any) => {
        ...
        const loadImage = (canvas: any): void => {
            ...
            img.onload = (): void => {
                ...
                // テクスチャオブジェクトの作成
                const tex: any = gl.createTexture();
