...
import { CubismDefaultParameterId } from '../live2d-sdk/cubismdefaultparameterid';
import { CubismModelSettingJson } from '../live2d-sdk/cubismmodelsettingjson';
import {
    BreathParameterData,
    CubismBreath
} from '../live2d-sdk/effect/cubismbreath';
import { CubismEyeBlink } from '../live2d-sdk/effect/cubismeyeblink';
import { ICubismModelSetting } from '../live2d-sdk/icubismmodelsetting';
import { CubismIdHandle } from '../live2d-sdk/id/cubismid';
import { CubismFramework } from '../live2d-sdk/live2dcubismframework';
import { CubismMatrix44 } from '../live2d-sdk/math/cubismmatrix44';
import { CubismUserModel } from '../live2d-sdk/model/cubismusermodel';
import {
    ACubismMotion,
    FinishedMotionCallback
} from '../live2d-sdk/motion/acubismmotion';
import { CubismMotion } from '../live2d-sdk/motion/cubismmotion';
import {
    CubismMotionQueueEntryHandle,
    InvalidMotionQueueEntryHandleValue
} from '../live2d-sdk/motion/cubismmotionqueuemanager';
import { csmMap } from '../live2d-sdk/type/csmmap';
import { csmRect } from '../live2d-sdk/type/csmrectf';
import { csmString } from '../live2d-sdk/type/csmstring';
import { csmVector } from '../live2d-sdk/type/csmvector';
import { CubismLogInfo } from '../live2d-sdk/utils/cubismdebug';
...
export class LAppModel extends CubismUserModel {
        ...
        if (this._modelSetting.getModelFileName() != '') {
            ...
            LAppModel.loadArrayBuffer(`${this._modelHomeDir}${modelFileName}`, (arrayBuffer) => {
                ...
                try {
                    ...
                    console.log('[LAppModel] loadModel done, _model=', !!this._model);
                } catch (e) {
    ...
    //  usercode
    public setExpression1(no: number): void {
    ...
    public preLoadMotionGroup(group: string): void {
        for (let i = 0; i < this._modelSetting.getMotionCount(group); i++) {
            ...
            LAppModel.loadArrayBuffer(`${this._modelHomeDir}${motionFileName}`, (arrayBuffer) => {
                ...
                tmpMotion.setEffectIds(this._eyeBlinkIds,
                    this._lipSyncIds);
    ...
    public constructor() {
        ...
        console.log(CubismFramework.getIdManager())
