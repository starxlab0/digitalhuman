 ...
 */
 ...
 import { CubismViewMatrix } from '../live2d-sdk/math/cubismviewmatrix';
    ...
    if (imageName) {
      ...
      const initBackGroundTexture = (textureInfo: TextureInfo): void => {
       ...
       //  this._back = new LAppSprite(x, y, fwidth, fheight, textureInfo.id);
        this._back = new LAppSprite(x, y, windowInfo.screenWidth, windowInfo.screenHeight, textureInfo.id);
      };
