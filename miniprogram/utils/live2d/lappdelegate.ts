...
import { CubismFramework, Option } from '../live2d-sdk/live2dcubismframework';
...
export class LAppDelegate {
  ...
  public initialize(): boolean {
    ...
    wx.createSelectorQuery().select('#myCanvas').node((res: any) => {
        canvas = res.node;
   ...
   */
  public initCanvas(webglCanvas: any): void {
