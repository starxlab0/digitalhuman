        ...
        export const ModelDir: string[] = ['Haru'];// 少女形象
        export const scale1:number=1;
        export const translate1:{x:number,y:number}={x:-0.0,y:0};
        ...
        export const ModelDirSize: number = ModelDir.length;
         ...
         // 相対パス
         export const ResourcesPath = 'https://cdn.jsdelivr.net/gh/Live2D/CubismWebSamples@develop/Samples/Resources/';// jsDelivr CDN 加载官方 Natori 模型
